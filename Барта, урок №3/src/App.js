...
import Form from './components/Form_name';


// TODO:
// 1. постарайтесь розбити даний файл на окремі компоненти,
//    дизайн компонент придумайте самі (назви, змінні, функціонал);
// 2. вивід labels вам необхідно зробити у циклі з використанням map функції,
//    для цього вам необхідно придумати дизайн вашого state (як розмістити змінні та константи);
...
class App extends Component {
  ...
  handleNameSubmit(event){
	// ключове свого this дозволяє нам доступатись до елементів форми
	// у даному прикладі, через refs можемо звертатись до input поля
  ...
  handleQuestionSubmit(event){
	// TODO: вивести дані після проходження survey у console.log()
  }
  ...
  render() {
    ...
    if(this.state.name && this.state.submitted === false){
      ...
      questions = '';
		...
		// ось тут ми додамо вивід повідомлення після проходження survey
		// поки тут най буде пусто
    }
    return (
      <div className="App">
        <Header></Header>
